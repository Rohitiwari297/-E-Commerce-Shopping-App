      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="w-full lg:w-1/2 space-y-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="px-3 py-1 bg-gray-100 text-gray-500 rounded-full text-xs font-bold">{address.length} Saved</span>
          </div>
          ...
          <div className="bg-gray-50/50 rounded-3xl p-6 border border-gray-100 h-full">
            {!showModal ? (
              <div className="h-full flex flex-col items-center justify-center text-center p-8">
                ...
                <p className="text-gray-400 text-sm mb-8 max-w-[240px]">Add a new delivery address for a faster checkout experience.</p>
              ...
              <div className="animate-fadeIn">
                ...
                <div className="flex gap-3 mb-6">
                  {['home', 'work'].map((type) => (
                    <label
                      key={type}
                      className={`flex-1 flex items-center justify-center gap-2 p-3 rounded-xl border-2 cursor-pointer transition-all font-bold capitalize text-sm
                    ${
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <input
                    ...
                    onChange={handleChange}
                    className="bg-white border border-gray-100 p-3.5 rounded-xl text-sm font-semibold focus:ring-4 focus:ring-green-600/5 focus:border-green-600 outline-none transition-all"
                  />
                  <input
                    name="mobile"
                  ...
                  <input
                    ...
                    className="sm:col-span-2 bg-white border border-gray-100 p-3.5 rounded-xl text-sm font-semibold focus:ring-4 focus:ring-green-600/5 focus:border-green-600 outline-none transition-all"
