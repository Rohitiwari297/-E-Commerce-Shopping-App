...
function Category() {
  ...
  const categories = [
    ...
    { id: 2, name: "Breakfast, Dips & Spreads", image: "../../public/chal.png" },
    { id: 3, name: "Masalas, Oils & Dry Fruits", image: "../../public/makha.png" },
    { id: 4, name: "Chips, Biscuits & Namkeens", image: "../../public/img.jpeg" },
    ...
    { id: 12, name: "Kitchen, Pooja & Homeware", image: "../../public/chal.png" },
