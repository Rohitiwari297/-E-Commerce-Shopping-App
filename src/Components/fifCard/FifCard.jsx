...
function ProductCard({ product }) {
  ...
  return (
    <div className="bg-white rounded-3xl shadow-lg relative p-4 flex flex-col items-center mb-5">
      ...
      {/* Product Name */}
      <h3 className="text-center text-green-700 font-bold text-sm mt-6">
        {product.name}
      </h3>
      ...
      <p className="text-[10px] text-gray-600 mt-2 text-center">
        ...
        amet obcaecati aliquam veritatis odio corrupti nisi
      </p>
          ...
          {!isAdded ? (
            ...
            <div className="flex items-center justify-between space-x-2 bg-white px-4 py-1 rounded-full shadow">
              <button
                ...
                className="text-green-600 font-bold text-xl hover:bg-green-50 hover:text-green-700 transition"
              >
                -
              </button>
